...
def imresize(x, shape, method=Image.BILINEAR):
...
def main():
    ...
    data, compare, z = z_calc(x_resized)
    ...
    cimg = ax.imshow(x_resized, origin='lower', aspect='auto', interpolation='none')

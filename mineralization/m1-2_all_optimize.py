...
def optimize_curve(M1_days, M1_data_extension, M2_days, M2_data_extension, **fit_kwargs):
    ...
    local_opt.set_lower_bounds([15., .001, -40., 25., .0035, -70.])
    local_opt.set_upper_bounds([160., .015, 40., 160., .015, 100.])
    local_opt.set_min_objective(f_objective)

    global_opt = nlopt.opt(nlopt.G_MLSL_LDS, 6)
    global_opt.set_maxeval(1000000)
    global_opt.set_lower_bounds([15., .001, -40., 25., .0035, -70.])
    global_opt.set_upper_bounds([160., .015, 40., 160., .015, 100.])
    ...
    x_opt = global_opt.optimize([40., .005, 0., 40., .005, 0.])

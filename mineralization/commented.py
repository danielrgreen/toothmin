...
# Define curve
'''
numpy.hstack(tup) stacks arrays in a horizontal (columnar) sequence:
arrays are then combined into a single new array (hsplit reverses).
Input parameter is tuple sequence of ndarrays, output a stacked ndarray.    
'''

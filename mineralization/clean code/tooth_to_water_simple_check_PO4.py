...
def water_hist_likelihood(w_iso_hist, PO4_t, PO4_pause, PO4_flux, **kwargs):
    ...
    print "M1_inverse_PO4_hist_2", M1_inverse_PO4_hist_2
    ...
    print "M1_inverse_PO4_hist_3", M1_inverse_PO4_hist_3
...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    forward_962_phosphate_eq = new_PO4_equations(3.0, 34.5, .3, forward_962_blood_hist)
    ...
    M2_inverse_PO4_eq = new_PO4_equations(3.0, 34.5, .3, M2_inverse_blood_hist)

...
def water_hist_likelihood(w_iso_hist, switch_params, PO4_t, PO4_pause, PO4_flux, **kwargs):
    ...
    M2_inverse_PO4_eq_short = PO4_dissoln_reprecip(6.2, 14.8, 1.00, M2_inverse_blood_hist, **kwargs)
    M2_inverse_PO4_eq_long = PO4_dissoln_reprecip(3.1, 60., 1.00, M2_inverse_blood_hist, **kwargs)
    M2_inverse_PO4_eq = (M2_inverse_PO4_eq_short*0.484 + M2_inverse_PO4_eq_long*0.065 + M2_inverse_blood_hist*.451)
...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    M2_inverse_PO4_eq_short = PO4_dissoln_reprecip(6.2, 14.8, 1.00, forward_962_blood_hist, **kwargs)
    M2_inverse_PO4_eq_long = PO4_dissoln_reprecip(3.1, 60., 1.00, forward_962_blood_hist, **kwargs)
    forward_962_phosphate_eq = (M2_inverse_PO4_eq_short*0.484 + M2_inverse_PO4_eq_long*0.065 + forward_962_blood_hist*.451)
    ...
    M2_inverse_PO4_eq_shortg = PO4_dissoln_reprecip(6.2, 14.8, 1.00, M2_inverse_blood_hist_gest, **kwargs)
    M2_inverse_PO4_eq_longg = PO4_dissoln_reprecip(3.1, 60., 1.00, M2_inverse_blood_hist_gest, **kwargs)
    M2_inverse_PO4_eqg = (M2_inverse_PO4_eq_shortg*0.484 + M2_inverse_PO4_eq_longg*0.065 + M2_inverse_blood_hist_gest*.451)
    ...
    fig.savefig('962trial_14d_rate75_19_PO4mixedweighted_{0}a_gestcurve.svg'.format(t_save), dpi=300, bbox_inches='tight')
    #plt.show()
    ...
    fig.savefig('962trial_14d_rate75_19_PO4mixedweighted_{0}b_gestcurve.svg'.format(t_save), dpi=300, bbox_inches='tight')
    #plt.show()

    fig = plt.figure()
    plt.hist(hist_list, bins=np.logspace(1.0, 5.0, 30), alpha=.6)
    plt.gca().set_xscale("log")
    fig.savefig('962trial_14d_rate75_19_PO4mixedweighted_{0}c_gestcurve.svg'.format(t_save), dpi=300, bbox_inches='tight')
    #plt.show()

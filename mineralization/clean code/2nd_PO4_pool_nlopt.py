...
def water_hist_likelihood(w_iso_hist, PO4_t, **kwargs):
    ...
    tooth_phosphate_eq = tooth_phosphate_reservoir(PO4_t, blood_hist, **kwargs)
    # Access tooth model
...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    trial_phosphate_eq = tooth_phosphate_reservoir(PO4_t, trial_blood_hist, **kwargs)
    ...
    fig.savefig('a-synch98_PO4opt_priora180s90_{0}b.svg'.format(t_save), dpi=300, bbox_inches='tight')
    plt.show()

...
def water_hist_prob(w_params, **kwargs):
    ...
    p, model_isomap = water_hist_likelihood(w_iso_hist, switch_params, 3.0, 45., .3, **kwargs)
...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    M2_inverse_PO4_eq = PO4_dissoln_reprecip(3.0, 45., .3, M2_inverse_blood_hist, **kwargs)
...
def main():
    ...
    fit_tooth_data('/Users/darouet/Documents/code/mineralization/clean code/962_tooth_iso_tooth.csv')

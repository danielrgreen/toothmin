...
def gen_isomaps(iso_shape, iso_data_x_ct, tooth_model, blood_step, day=-1):
    ...
    for k in xrange(len(model_isomap)):
        model_isomap[k] = model_isomap[k][:,2:,day] + 28.1 #*** No. in middle denotes deletion from bottom PHOSPHATE_OFFSET*** was 18.8
...
def main():
    ...
    fit_tooth_data('/Users/darouet/Documents/code/mineralization/clean code/s33_data.csv')

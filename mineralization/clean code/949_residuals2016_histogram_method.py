...
def fit_tooth_data(data_fname, number, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    first_experimental = forward_962_PO4_hist_m1[0]
    forward_962_blood_hist_m1_gest = np.append(first_experimental, forward_962_blood_hist_m1[m1_gestation:])
    forward_962_blood_hist_m1_gest[1] = -10.
    ...
    for offset in phosphate_offset_range:
        ...
        print forward_962_blood_hist_m1_gest
        #return 0

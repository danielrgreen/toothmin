...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    local_opt.set_lower_bounds([-30., -30., 5., 5.])
    local_opt.set_upper_bounds([0., 0., 150., 150.])
    ...
    global_opt.set_lower_bounds([-30., -30., 5., 5.])
    global_opt.set_upper_bounds([0., 0., 150., 150.])
    ...
    t1 = time()
    x_opt = global_opt.optimize([-6., -19., 40., 40.])
    ...
    trial_phosphate_eq = PO4_dissoln_reprecip(17.609, 34.515, .54922, trial_blood_hist, **kwargs) #***** 17.609, 34.515, 54.922 *****
    ...
    fig.savefig('a-synch86os_PO4flux_newdelta_{0}a.svg'.format(t_save), dpi=300, bbox_inches='tight')
    plt.show()
    ...
    fig.savefig('a-synch86os_PO4flux_newdelta_{0}b.svg'.format(t_save), dpi=300, bbox_inches='tight')
    plt.show()

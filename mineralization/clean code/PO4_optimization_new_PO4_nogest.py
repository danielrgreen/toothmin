...
def water_hist_likelihood(PO4_half, PO4_pause, PO4_frac, **kwargs):
    ...
    forward_962_PO4_hist_m2_gest = forward_962_phosphate_eq
...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    forward_962_blood_hist_m1_gest = forward_962_blood_hist_m1
    forward_962_PO4_hist_m1_gest = forward_962_PO4_hist_m1
    ...
    ax1.plot(days, inverse_962_phosphate_eq, 'g-', linewidth=1.0)
...
def main():
    ...
    fit_tooth_data('/Users/darouet/Documents/code/mineralization/clean code/962_data.csv')

...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    fig.savefig('1D_{0}_rate1o3_18p6_{1}a.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('1D_{0}_rate1o3_18p6_{1}b.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    ax1.set_xlim(84, 550)
    fig.savefig('1D_rate1o3_18p6_{0}_{1}b2.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('1D_rate1o3_18p6_{0}_{1}b3.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

    fig = plt.figure()
    plt.hist(hist_list, bins=np.logspace(0.0, 5.0, 30), alpha=.6)
    plt.gca().set_xscale("log")
    plt.savefig('1D_{0}_rate1o3_18p6_{1}c.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

    fig = plt.figure()
    ax1 = fig.add_subplot(1,1,1)
    ax1.hist(for_inv_diff, bins=np.linspace(-10.0, 10.0, 20), alpha=.6)
    fig.savefig('1D_rate1o3_18p6_{0}_{1}d.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    ax1.set_ylim(0, 220)
    fig.savefig('1D_rate1o3_18p6_{0}_{1}e.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

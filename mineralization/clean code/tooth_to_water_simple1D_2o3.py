...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    fig.savefig('1Dpx2o3_{0}_r2o3corr2_{1}a.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('1Dpx2o3_{0}_r2o3_{1}b.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

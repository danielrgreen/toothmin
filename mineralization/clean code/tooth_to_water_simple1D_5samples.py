...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    fig.savefig('1Dpx3_{0}_rate1o3_{1}a.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('1Dpx3_{0}_rate1o3_{1}b.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('1Dpx3_rate1o3_18p6_{0}_{1}b2.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    plt.savefig('1Dpx3_rate1o3_18p6_{0}_{1}c.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    ax1.set_ylim(0, 220)
    fig.savefig('1Dpx3_rate1o3_18p6_{0}_{1}e.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

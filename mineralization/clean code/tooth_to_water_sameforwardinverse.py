...
def fit_tooth_data(data_fname, model_fname='equalsize_jul2015a.h5', **kwargs):
    ...
    new_fname = 'PO4_{0}_{1}.csv'.format(number, t_save)

    print 'importing isotope data...'
    data_isomap, isomap_shape, isomap_data_x_ct = load_iso_data(new_fname)
    ...
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}a.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}b.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    ax1.set_xlim(84, 550)
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}b2.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}b3.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

    fig = plt.figure()
    plt.hist(hist_list, bins=np.logspace(0.0, 5.0, 30), alpha=.6)
    plt.gca().set_xscale("log")
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}c.svg'.format(number, t_save), dpi=300, bbox_inches='tight')

    fig = plt.figure()
    ax1 = fig.add_subplot(1,1,1)
    ax1.hist(for_inv_diff, bins=np.linspace(-10.0, 10.0, 20), alpha=.6)
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}d.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
    ...
    ax1.set_ylim(0, 220)
    fig.savefig('2D_r2o3_18p6_sigma50_fis_{0}_{1}e.svg'.format(number, t_save), dpi=300, bbox_inches='tight')
